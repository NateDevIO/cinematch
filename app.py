...
def main():
    ...
    st.markdown(
        ...
        "[View Source Code](https://github.com/NateDevIO/cinematch)"
    )
    st.markdown("<p style='text-align: center; font-size: 0.8em; color: gray;'>Coded by Nate</p>", unsafe_allow_html=True)
